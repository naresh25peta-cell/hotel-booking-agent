...
_SEARCH_AVAILABILITY_PROMPT_TEMPLATE = """
...
{sort_by_price_instruction}
Be concise and structured.
"""

_SORT_BY_PRICE_INSTRUCTION = "- The user wants cheap/budget hotels — call search_hotels with sort_by_price=True.\n"
...
def run_search_availability_agent(state: dict):
    ...
    sort_by_price = state.get("sort_by_price", False)
    prompt = _SEARCH_AVAILABILITY_PROMPT_TEMPLATE.format(
        sort_by_price_instruction=_SORT_BY_PRICE_INSTRUCTION if sort_by_price else ""
    )
